...
# 1
# 4
# Here it's a useless example, but it's handy when you know your function will return
# a huge set of values that you will only need to read once.
# To master yield, you must understand that when you call the function, the code you
# have written in the function body does not run. The function only returns the generator object, this is a bit tricky.
#
