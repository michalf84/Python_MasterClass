import timeit
# we changed code into string to exeutei n timeit

setup="""\
#gc.enable() GARBAGE COLLECTOR ENABLEMENT
...
for index, loc in enumerate(exits_to_destination_3):
    ...
    print(loc)
"""
#we added globals as locations is only defined in string next file will show how to fix it
